            ...
            <table class="table">
                ...
                <tr style="background: #ffffcc">
                    <td colspan="2" class="text-left"
                        ...
                        <img src="${imgURL}${g.fname2}" class="img-fluid"><br>
                        </c:if>
                ...
                <c:if test="${not empty g.fname2}">
                <tr><td class="text-left">이미지2</td><td>${g.fname2} (1.3MB)</td></tr>
                </c:if>
                <c:if test="${not empty g.fname2}">
                <tr><td class="text-left">이미지3</td><td>${g.fname3} (0.9MB)</td></tr>
                </c:if>
            </table>
        </div><!-- 본문 -->
